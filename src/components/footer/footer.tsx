    ...
    <footer class="footer px-10 py-20 bg-base-200 text-base-content">
      <aside>
        <svg
          ...
          class={`${
            animate.value &&
            "animate-fade-right animate-duration-1000 animate-delay-100 ease-in-out"
          } fill-current`}>
        ...
        <p
          ...
          <br />
          certified fitness consultant & sports nutrition advisor.
        </p>
      </aside>
      <nav
        class={`${
        ...
        <div class="grid gap-4">
          <a href="https://www.youtube.com/@zafiranam">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
          ...
          <a
            ...
            href="https://www.facebook.com/profile.php?id=100069951046181">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
